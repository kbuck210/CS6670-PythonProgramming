...
# Rather than copying the function from my file traverser module to here, 
# import the module instead, it seems cleaner this way
import file_traverser

## Get Traversal Data function returns the result of calling the directory
## traverser method in file_traverser.py
def get_traversal_data():
    return file_traverser.traverse_dirs()

## Function to get the data, residing in a separate module
def getData():
...
# Function used to return the number of lines in the quote data (used in my
# searching logic)
def number_of_lines():
    return len(getData())
